...
exports.simulatedMarketSource = exports.SimulatedMarketDataSource = void 0;
class SimulatedMarketDataSource {
    ...
    generateTickForSymbol(symbol, indexPctChange = 0.0) {
...
exports.SimulatedMarketDataSource = SimulatedMarketDataSource;
// Global singleton instance for app runtime
exports.simulatedMarketSource = new SimulatedMarketDataSource();
